...
export default (config, postcss) => {
    ...
    const definitions = {
        ...
        'row-start': {
            1: { properties: [{ prop: 'grid-row-start', value: '1' }] },
            2: { properties: [{ prop: 'grid-row-start', value: '2' }] },
            3: { properties: [{ prop: 'grid-row-start', value: '3' }] },
            4: { properties: [{ prop: 'grid-row-start', value: '4' }] },
            5: { properties: [{ prop: 'grid-row-start', value: '5' }] },
            6: { properties: [{ prop: 'grid-row-start', value: '6' }] },
            7: { properties: [{ prop: 'grid-row-start', value: '7' }] },
            8: { properties: [{ prop: 'grid-row-start', value: '8' }] },
            9: { properties: [{ prop: 'grid-row-start', value: '9' }] },
            10: { properties: [{ prop: 'grid-row-start', value: '10' }] },
            11: { properties: [{ prop: 'grid-row-start', value: '11' }] },
            12: { properties: [{ prop: 'grid-row-start', value: '12' }] },
        },
        'row-end': {
            1: { properties: [{ prop: 'grid-row-end', value: '1' }] },
            2: { properties: [{ prop: 'grid-row-end', value: '2' }] },
            3: { properties: [{ prop: 'grid-row-end', value: '3' }] },
            4: { properties: [{ prop: 'grid-row-end', value: '4' }] },
            5: { properties: [{ prop: 'grid-row-end', value: '5' }] },
            6: { properties: [{ prop: 'grid-row-end', value: '6' }] },
            7: { properties: [{ prop: 'grid-row-end', value: '7' }] },
            8: { properties: [{ prop: 'grid-row-end', value: '8' }] },
            9: { properties: [{ prop: 'grid-row-end', value: '9' }] },
            10: { properties: [{ prop: 'grid-row-end', value: '10' }] },
            11: { properties: [{ prop: 'grid-row-end', value: '11' }] },
            12: { properties: [{ prop: 'grid-row-end', value: '12' }] },
            13: { properties: [{ prop: 'grid-row-end', value: '13' }] },
        },
    };
